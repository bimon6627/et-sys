...
const SignIn: React.FC = () => {
  ...
  return (
    <form
      ...
      className="rounded-full border border-solid border-transparent transition-colors flex items-center justify-center cursor-pointer bg-eo-blue text-background gap-2 hover:bg-eo-lblue mx-auto text-sm md:text-base h-10 sm:h-12 px-1 sm:px-2 w-fit"
    >
