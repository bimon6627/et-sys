  ...
  const filteredRegions = useMemo(() => {
    ...
    return Object.keys(groupedData).filter((regionName) => {
      ...
      return Object.values(orgs).some((orgData) => {
        ...
        if (orgData.organization.name.toLowerCase().includes(lowerTerm)) return true;
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {Object.values(groupedData[regionName])
                      ...
                      .filter((orgData) => orgData.delegates.length > 0 || orgData.observers.length > 0 || (searchTerm && orgData.organization.name.toLowerCase().includes(searchTerm.toLowerCase()))) 
