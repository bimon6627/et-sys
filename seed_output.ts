...
// --- 1. PERMISSIONS ---
const permissions = [
  { slug: "case:read", description: "Can view cases", isSystemPermission: false },
  { slug: "case:write", description: "Can edit/approve cases", isSystemPermission: false },
  { slug: "case:delete", description: "Can delete cases", isSystemPermission: false },
  { slug: "hse:write", description: "Can create and modify hse incidents", isSystemPermission: false },
  { slug: "hse:read", description: "Can view hse incidents", isSystemPermission: false },
  { slug: "hse:delete", description: "Can delete hse incidents", isSystemPermission: false },
  { slug: "participant:write", description: "Can create and modify participants", isSystemPermission: false },
  { slug: "participant:read", description: "Can view participants", isSystemPermission: false },
  { slug: "participant:delete", description: "can delete participants", isSystemPermission: false },
  { slug: "participant:regional_read", description: "Can view participants in the same region", isSystemPermission: false },
  { slug: "admin:view", description: "Can view admin dashboard", isSystemPermission: true },
  { slug: "conference:write", description: "Can create conferences", isSystemPermission: true },
  { slug: "conference:write_regional", description: "Can create conferences limited to the user's region", isSystemPermission: true },
  { slug: "conference:read", description: "Can view conferences", isSystemPermission: true },
  { slug: "conference:read_regional", description: "Can view conferences limited by the user's region", isSystemPermission: true },
  { slug: "conference:delete", description: "Can delete conferences", isSystemPermission: true },
  { slug: "conference:delete_regional", description: "Can delete conferences limited to the user's region", isSystemPermission: true },
  { slug: "users:write", description: "Can create new users", isSystemPermission: true },
  { slug: "users:read", description: "Can view users", isSystemPermission: true },
  { slug: "users:delete", description: "Can delete users", isSystemPermission: true },
];

// --- 2. ROLES ---
const roles = [
  { name: "SEK_LEDELSE", description: "SEK_LEDELSE", permissions: ["hse:write", "hse:read", "hse:delete", "participant:write", "participant:read", "participant:delete"] },
  { name: "KONKOM", description: "KONKOM", permissions: ["case:read", "case:write", "case:delete", "participant:write", "participant:read", "participant:delete"] },
  { name: "SEK", description: "SEK", permissions: ["hse:write", "hse:read", "participant:write", "participant:read", "participant:delete"] },
  { name: "TEST", description: null, permissions: ["participant:regional_read", "conference:write_regional", "conference:read_regional", "conference:delete_regional"] },
  { name: "ADMIN", description: "ADMIN", permissions: ["case:read", "case:write", "case:delete", "hse:write", "hse:read", "hse:delete", "participant:write", "participant:read", "participant:delete", "admin:view", "conference:write", "conference:read", "conference:delete", "users:write", "users:read", "users:delete"] },
];
...
const regions = [
  ...
  { name: "Individuelt Medlemsskap", global: false, internal: true, parent: null },
];

// --- 4. ORGANIZATIONS ---
const organizations = [
  { name: "Eilert Sundt videregående skole, avd Farsund", canVote: true, region: "Agder" },
  ...
  { name: "Roald Amundsen videregående skole", canVote: true, region: "Akershus" },
  ...
  { name: "Akademiet Ypsilon videregående skole AS", canVote: true, region: "Buskerud" },
  { name: "Hokksund ungdomsskole", canVote: true, region: "Buskerud" },
  { name: "Båtsfjord Private videregående skole", canVote: true, region: "Finnmark" },
  ...
  { name: "Engerdal barne- og ungdomsskole", canVote: true, region: "Innlandet" },
  ...
  { name: "Lillehammer Videregående Skole avd Sør", canVote: true, region: "Innlandet" },
  ...
  { name: "Eilert Sundt videregående skole, avd Lyngdal", canVote: true, region: "Agder" },
  { name: "Hadeland Videregående Skole", canVote: true, region: "Innlandet" },
  { name: "Lena-Valle Videregående Skole", canVote: true, region: "Innlandet" },
  { name: "Buskerud videregående skole avd. Rosthaug", canVote: true, region: "Buskerud" },
  { name: "Nord-Gudbrandsdalen Videregående Skole avd Otta", canVote: true, region: "Innlandet" },
  ...
  { name: "Flekkefjord videregående skole avd Flekkefjord", canVote: true, region: "Agder" },
  { name: "Kristiansand katedralskole Gimle", canVote: true, region: "Agder" },
  ...
  { name: "Briskeby videregående skole AS", canVote: true, region: "Buskerud" },
  ...
  { name: "St. Hallvard videregående skole", canVote: true, region: "Buskerud" },
  { name: "Akademiet Realfagsgymnas Sandvika", canVote: true, region: "Akershus" },
  { name: "Bjørkelangen videregående skole", canVote: true, region: "Akershus" },
  ...
  { name: "Lillestrøm videregående skole", canVote: true, region: "Akershus" },
  ...
  { name: "Rosenvilde videregående skole", canVote: true, region: "Akershus" },
  ...
  { name: "Lillehammer Videregående Skole avd Nord", canVote: true, region: "Innlandet" },
  ...
  { name: "Hammerfest videregående skole", canVote: true, region: "Finnmark" },
  ...
  { name: "Samisk videregående skole og reindriftsskole avd. Kautokeino", canVote: true, region: "Finnmark" },
  { name: "Samisk videregående skole avd. Karasjok", canVote: true, region: "Finnmark" },
  { name: "Hamar Katedralskole", canVote: true, region: "Innlandet" },
  { name: "Nord-Østerdal Videregående Skole", canVote: true, region: "Innlandet" },
  { name: "Ringsaker Videregående Skole", canVote: true, region: "Innlandet" },
  ...
  { name: "Kolvikbakken ungdomsskole", canVote: true, region: "Møre og Romsdal" },
  { name: "Myklebust Skule", canVote: true, region: "Møre og Romsdal" },
  { name: "Måndalen skule", canVote: true, region: "Møre og Romsdal" },
  { name: "Skarbøvik Ungdomsskole", canVote: true, region: "Møre og Romsdal" },
  { name: "Sunndal Ungdomsskole", canVote: true, region: "Møre og Romsdal" },
  { name: "Surnadal Videregående Skole", canVote: true, region: "Møre og Romsdal" },
  { name: "Åfarnes Barne- Og Ungdomsskole", canVote: true, region: "Møre og Romsdal" },
  { name: "Ålesund Videregående Skole avd Volsdalsberga", canVote: true, region: "Møre og Romsdal" },
  ...
  { name: "Hadsel Videregående Skole avd Melbu", canVote: true, region: "Nordland" },
  ...
  { name: "Narvik Videregående Skole avd Oscarsborg", canVote: true, region: "Nordland" },
  ...
  { name: "Utskarpen Barne- og Ungdomsskole", canVote: true, region: "Nordland" },
  ...
  { name: "Aust-Lofoten Videregående Skole", canVote: true, region: "Nordland" },
  { name: "Bodin videregående skole og maritime fagskole", canVote: true, region: "Nordland" },
  { name: "Bodø Videregående Skole", canVote: true, region: "Nordland" },
  { name: "Brønnøysund Videregående Skole", canVote: true, region: "Nordland" },
  { name: "Fauske Videregående Skole avd Vestmyra", canVote: true, region: "Nordland" },
  { name: "Hadsel Videregående Skole avd Stokmarknes", canVote: true, region: "Nordland" },
  { name: "Hilstad Barne- Og Ungdomsskole", canVote: true, region: "Nordland" },
  { name: "Kristen Videregående Skole Nordland", canVote: true, region: "Nordland" },
  { name: "Løpsmark Skole", canVote: true, region: "Nordland" },
  { name: "Gjermundnes videregående skole", canVote: true, region: "Møre og Romsdal" },
  { name: "Narvik Videregående Skole avd Frydenlund", canVote: true, region: "Nordland" },
  { name: "Polarsirkelen Videregående Skole", canVote: true, region: "Nordland" },
  { name: "Sandnessjøen Videregående Skole", canVote: true, region: "Nordland" },
  { name: "Vest-Lofoten Videregående Skole", canVote: true, region: "Nordland" },
  { name: "Ørnes Skole", canVote: true, region: "Nordland" },
  { name: "Meløy videregående skole", canVote: true, region: "Nordland" },
  { name: "Sortland videregående skole avd. Sortland, Kleiva og Øksnes", canVote: true, region: "Nordland" },
  ...
  { name: "Ørsta Videregående Skole", canVote: true, region: "Møre og Romsdal" },
  { name: "Etterstad Videregående Skole", canVote: true, region: "Oslo" },
  { name: "Storsteigen Videregående Skole", canVote: true, region: "Innlandet" },
  { name: "Blindheim ungdomsskole", canVote: true, region: "Møre og Romsdal" },
  { name: "Borgund videregående skole", canVote: true, region: "Møre og Romsdal" },
  { name: "Hustadvika videregående skole", canVote: true, region: "Møre og Romsdal" },
  { name: "Hersleb Videregående Skole", canVote: true, region: "Oslo" },
  { name: "Haram videregående skole", canVote: true, region: "Møre og Romsdal" },
  { name: "Kristiansund Videregående Skole", canVote: true, region: "Møre og Romsdal" },
  { name: "Molde Videregående Skole", canVote: true, region: "Møre og Romsdal" },
  { name: "Romsdal Videregående Skole", canVote: true, region: "Møre og Romsdal" },
  { name: "Spjelkavik Videregående Skole", canVote: true, region: "Møre og Romsdal" },
  { name: "Stranda Videregående Skole", canVote: true, region: "Møre og Romsdal" },
  { name: "Sunndal Videregående Skole", canVote: true, region: "Møre og Romsdal" },
  { name: "Sykkylven videregående skole", canVote: true, region: "Møre og Romsdal" },
  { name: "Tingvoll Videregående Skole", canVote: true, region: "Møre og Romsdal" },
  { name: "Ulstein Videregående Skole", canVote: true, region: "Møre og Romsdal" },
  { name: "Volda Videregående Skole", canVote: true, region: "Møre og Romsdal" },
  { name: "Rudolf Steinerskolen i Oslo", canVote: true, region: "Oslo" },
  { name: "Atlanten videregående skole", canVote: true, region: "Møre og Romsdal" },
  { name: "Rauma videregående skole", canVote: true, region: "Møre og Romsdal" },
  ...
  { name: "Fyrstikkalleén Videregående Skole", canVote: true, region: "Oslo" },
  ...
  { name: "Narvik Videregående Skole avd Solhaugen", canVote: true, region: "Nordland" },
  ...
  { name: "Stiftelsen Den Tyske Skoleforening i Norge", canVote: true, region: "Oslo" },
  ...
  { name: "Nome videregående skole, avd Lunde", canVote: true, region: "Telemark" },
  { name: "Nome videregående skole, avd Søve", canVote: true, region: "Telemark" },
  { name: "Telemark toppidrett ungdomsskole", canVote: true, region: "Telemark" },
  { name: "Vest-Telemark videregående skole, avd Dalen og Seljord", canVote: true, region: "Telemark" },
  ...
  { name: "Guri Kunna Videregående Skole", canVote: true, region: "Trøndelag" },
  { name: "Halsen Ungdomsskole", canVote: true, region: "Trøndelag" },
  { name: "Inderøy Videregående Skole", canVote: true, region: "Trøndelag" },
  { name: "Johan Bojer videregående skole", canVote: true, region: "Trøndelag" },
  { name: "Kyrksæterøra videregående skole", canVote: true, region: "Trøndelag" },
  ...
  { name: "Thora Storm Videregående Skole", canVote: true, region: "Trøndelag" },
  { name: "Trondheim international school", canVote: true, region: "Trøndelag" },
  { name: "Vikhammer Ungdomsskole", canVote: true, region: "Trøndelag" },
  { name: "Levanger Videregående Skole", canVote: true, region: "Trøndelag" },
  { name: "Nord-Troms videregående skole (avd. Nordreisa og Skjervøy)", canVote: true, region: "Troms" },
  { name: "Sørreisa sentralskole", canVote: true, region: "Troms" },
  { name: "Bybroen Videregående Skole AS", canVote: true, region: "Trøndelag" },
  { name: "Senja videregående skole, avd. Finnfjordbotn", canVote: true, region: "Troms" },
  ...
  { name: "Steinerskolen i Trondheim, Grunnskole", canVote: true, region: "Trøndelag" },
  { name: "Steinkjer Videregående Skole", canVote: true, region: "Trøndelag" },
  ...
  { name: "Ytre Namdal Videregående Skole", canVote: true, region: "Trøndelag" },
  ...
  { name: "Vardafjell videregående skole", canVote: true, region: "Rogaland" },
  ...
  { name: "Hjalmar Johansen videregående skole", canVote: true, region: "Telemark" },
  ...
  { name: "Longyearbyen skole, videregående skole", canVote: true, region: "Troms" },
  { name: "Lærlingrådet i Trøndelag", canVote: true, region: "Trøndelag" },
  { name: "Senja videregående skole, avd. Gibostad", canVote: true, region: "Troms" },
  ...
  { name: "Olav Duun Videregående Skole", canVote: true, region: "Trøndelag" },
  { name: "Ole Vig Videregående Skole", canVote: true, region: "Trøndelag" },
  { name: "Skjetlein Videregående Skole", canVote: true, region: "Trøndelag" },
  ...
  { name: "Steinerskolen i Vestfold - Grunnskolen på Nøtterøy", canVote: true, region: "Vestfold" },
  { name: "Steinerskolen i Vestfold - Slottsfjellet videregående", canVote: true, region: "Vestfold" },
  { name: "Askvoll Skole", canVote: true, region: "Vestland" },
  { name: "Bergen Katedralskole avd Kyrre", canVote: true, region: "Vestland" },
  ...
  { name: "Langhaugen Videregående Skole", canVote: true, region: "Vestland" },
  ...
  { name: "Kirkebygden ungdomsskole (Våler)", canVote: true, region: "Østfold" },
  { name: "Knapstad brane- og ungdomsskole", canVote: true, region: "Østfold" },
  ...
  { name: "Steinerskolen i Moss, grunnskole", canVote: true, region: "Østfold" },
  { name: "Steinerskolen i Moss, videregående skole", canVote: true, region: "Østfold" },
  { name: "Trøgstad ungdomsskole", canVote: true, region: "Østfold" },
  { name: "Vestbygda ungdomsskole", canVote: true, region: "Østfold" },
  { name: "Distriktskomiteene i Operasjon Dagsverk", canVote: false, region: "Elevorganisasjonen" },
  { name: "Elevorganisasjonen i Telemark", canVote: false, region: "Elevorganisasjonen" },
  { name: "Elevorganisasjonen i Vestfold", canVote: false, region: "Elevorganisasjonen" },
  { name: "Gjest med innvilget talerett", canVote: false, region: "Elevorganisasjonen" },
  { name: "Olsvikåsen Videregående Skole", canVote: true, region: "Vestland" },
  { name: "Amalie Skram Videregående Skole", canVote: true, region: "Vestland" },
  ...
  { name: "Fyllingsdalen Videregående Skole", canVote: true, region: "Vestland" },
  ...
  { name: "Nordahl Grieg Videregående Skole", canVote: true, region: "Vestland" },
  ...
  { name: "Bømlo Videregående skole, avd. Rubbestadneset", canVote: true, region: "Vestland" },
  ...
  { name: "Sotra Videregående Skole avd Bildøy", canVote: true, region: "Vestland" },
  { name: "Sotra Videregående Skole avd Sund", canVote: true, region: "Vestland" },
  ...
  { name: "Elevorganisasjonen i Oslo Øst", canVote: false, region: "Elevorganisasjonen" },
  ...
  { name: "Elevorganisasjonen i Nordland", canVote: false, region: "Elevorganisasjonen" },
  { name: "Elevorganisasjonen i Oslo Vest", canVote: false, region: "Elevorganisasjonen" },
  { name: "Elevorganisasjonen i Trøndelag", canVote: false, region: "Elevorganisasjonen" },
  { name: "Elevorganisasjonen i Innlandet", canVote: false, region: "Elevorganisasjonen" },
  { name: "Elevorganisasjonen i Vestland", canVote: false, region: "Elevorganisasjonen" },
  { name: "Elevorganisasjonen i Rogaland", canVote: false, region: "Elevorganisasjonen" },
  { name: "Elevorganisasjonen i Agder", canVote: false, region: "Elevorganisasjonen" },
  { name: "Elevorganisasjonen i Oslo", canVote: false, region: "Elevorganisasjonen" },
  { name: "Elevorganisasjonen i Møre og Romsdal", canVote: false, region: "Elevorganisasjonen" },
  { name: "Elevorganisasjonen i Oslo Sentrum", canVote: false, region: "Elevorganisasjonen" },
  { name: "Elevorganisasjonen i Trondheim", canVote: false, region: "Elevorganisasjonen" },
  { name: "Elevorganisasjonen i Bergen", canVote: false, region: "Elevorganisasjonen" },
  { name: "Akademiet Fredrikstad AS", canVote: true, region: "Østfold" },
  { name: "Elevorganisasjonen i Buskerud", canVote: false, region: "Elevorganisasjonen" },
  { name: "Askim ungdomsskole", canVote: true, region: "Østfold" },
  { name: "Elevorganisasjonen i Akershus", canVote: false, region: "Elevorganisasjonen" },
  { name: "Elevorganisasjonen i Østfold", canVote: false, region: "Elevorganisasjonen" },
  { name: "Elevorganisasjonen i Troms", canVote: false, region: "Elevorganisasjonen" },
  { name: "Elevorganisasjonen i Finnmark", canVote: false, region: "Elevorganisasjonen" },
  ...
  { name: "Frederik II videregående skole", canVote: true, region: "Østfold" },
  ...
  { name: "Kirkeparken videregående skole", canVote: true, region: "Østfold" },
  ...
  { name: "Bømlo Videregående Skole, avd. Leite", canVote: true, region: "Vestland" },
  ...
  { name: "Hovedkomiteen i Operasjon Dagsverk", canVote: false, region: "Elevorganisasjonen" },
  { name: "Ordstyrerbordet", canVote: false, region: "Elevorganisasjonen" },
  { name: "Referenter", canVote: false, region: "Elevorganisasjonen" },
  { name: "Holmestrand videregående skole", canVote: true, region: "Vestfold" },
  { name: "Stiftelsen Toppidrettsgymnaset i Telemark", canVote: true, region: "Telemark" },
  { name: "Asker videregående skole", canVote: true, region: "Akershus" },
  { name: "Rudolf Steinerskolen stiftelsen avd. Undervisning (Nesodden)", canVote: true, region: "Akershus" },
  { name: "Hillesøyskolen - Brensholmen skole", canVote: true, region: "Troms" },
  { name: "Individuelt medlem i Elevorganisasjonen", canVote: false, region: "Individuelt Medlemsskap" },
  { name: "Nord-Salten videregående skole (avd Joarkkaskåvllå og Steigen)", canVote: true, region: "Nordland" },
  { name: "Flekkefjord Vgs studiested Kvinesdal", canVote: true, region: "Agder" },
  ...
  { name: "Charlottenlund Videregående Skole", canVote: true, region: "Trøndelag" },
  { name: "Laksevåg og Bergen Maritime Videregående Skole", canVote: true, region: "Vestland" },
  { name: "Ålesund videregående skole avd Fagerlia", canVote: true, region: "Møre og Romsdal" },
  { name: "Setesdal Videregående Skole avd Valle, Hovden og Hornes", canVote: true, region: "Agder" },
...
// --- 5. WHITELIST USERS ---
const users = [
  { email: "birk@elev.no", name: null, role: "ADMIN", region: "Elevorganisasjonen" },
  { email: "birk.monsen@gmail.com", name: null, role: "TEST", region: "Oslo" },
